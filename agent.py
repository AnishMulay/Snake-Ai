...
from model import Linear, Trainer
...
class Agent:
	...
	def __init__(self):
		...
		self.memory = deque(maxlen=MAX_MEMORY) # pops from left if memory limit is exceeded
...
def train():
	...
	while True:
		...
		if done:
			...
			print('Game', agent.num_games, 'Score', score, 'Highscore', max_score)
